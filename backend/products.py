...
SEED = [
    ...
    dict(code="PF994", name="Vitamine D3 50 000 UI Green Castel",
         ...
         storage="Température ambiante, < 25 °C", barcode="6194000994019",
    ...
    dict(code="PF954", name="Calcimax", sku="FG-CALCIMAX-30",
         ...
         storage="Température ambiante, < 25 °C", barcode="6194000954013",
    ...
    dict(code="PF201", name="Sirop Magnésium + Vitamine B6 200 mL",
         ...
         storage="Après ouverture, conserver au réfrigérateur", barcode="6194000201018",
    ...
    dict(code="PF310", name="Gélules Spiruline 500 mg", sku="FG-SPIR-60",
         ...
         storage="À l'abri de l'humidité", barcode="6194000310017",
